...
<%@page import="ProjeSql.AddressDuzenle"%>
<%@page import="java.util.List"%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
 
<%
String userId = request.getParameter("id");
Address addr = new AddressDuzenle().getirId(Integer.valueOf(userId));
...
<body>
<form id="form" name="form" method="post" action="duzenle?id=${addr.IDX}" onsubmit="return isValid(this)">
<table border="0">
<tr>
<td width="150"><label for="adressCode">*Adress Code:</label></td>
<td> <input type="text" name="adressCode" id="adressCode" value="${addr.ADDRCODE}"/></td>
</tr>
<tr>
...
<td><textarea id="adress" name="adress" rows="4" cols="15">${addr.ADDRESS}
</textarea></td>
</tr>
<tr>
<td><label for="district">District: </label></td>
<td><input type="text" name="district" id="district" value="${addr.DISTRICT}" /></td>
</tr>
<tr>
<td><label for="zipcode">Zipcode: </label></td>
<td><input type="text" name="zipcode" id="zipcode" value="${addr.ZIPCODE}" /></td>
</tr>
<tr>
<td><label for="city">*City: </label></td>
<td><input type="text" name="city" id="city" value="${addr.CITY}" /></td>
</tr>
